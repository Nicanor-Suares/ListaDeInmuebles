...
public class MainActivity extends AppCompatActivity {
    ...
    public void cargarDatos() {
        lista.add(new Inmueble(R.drawable.casa1, "Sydney", 80000));
        lista.add(new Inmueble(R.drawable.casa2, "Melbourne", 90000));
        lista.add(new Inmueble(R.drawable.casa3, "Concaran", 100000));
    }
}